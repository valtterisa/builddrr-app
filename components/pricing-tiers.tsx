...
export function PricingTiers() {
  ...
  const savingsPercentage = Math.round(((proMonthlyPrice - proYearlyPrice / 12) / proMonthlyPrice) * 100)

  return (
    <section className="py-20 px-4 md:px-6 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
        ...
        <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
          ...
          <Card className="flex flex-col border-2 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 transform hover:-translate-y-1 hover:shadow-lg">
            <CardHeader className="pb-8 pt-8">
              ...
              <CardDescription className="text-base mt-2">Perfect for individuals and small projects</CardDescription>
              <div className="mt-4">
            ...
            <CardHeader className="pb-8 pt-8">
              ...
              <div className="mt-4">
                <span className="text-4xl font-bold">
                  ${billingInterval === "yearly" ? proYearlyPrice : proMonthlyPrice}
                </span>
                ...
                {billingInterval === "yearly" && (
                  <div className="text-sm text-muted-foreground mt-2">
                    Just ${(proYearlyPrice / 12).toFixed(2)}/month, billed annually
                  </div>
                )}
              </div>
            </CardHeader>
