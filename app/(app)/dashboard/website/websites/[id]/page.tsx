...
export default function WebsiteDetailPage({
  ...
  const handlePublish = async () => {
    try {
      const updatedWebsite = await updateWebsite(params.id, {
        published: !website.published,
      });
      setWebsite(updatedWebsite);
      toast({
        title: updatedWebsite.published
          ? "Website published"
          : "Website unpublished",
    ...
    <div className="container py-10 px-4 md:px-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8">
        ...
        <div className="mt-4 md:mt-0 flex gap-2">
          <Button
            variant="outline"
            onClick={() => router.push(`/website/editor?id=${params.id}`)}
          >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Preview how your website looks to visitors.
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex justify-between">
            <Button
              variant="outline"
              onClick={() => router.push(`/preview?id=${params.id}`)}
            >
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Upload and manage assets that you can use in your website
                content.
              </p>
            </CardContent>
            <CardFooter>
              <Button
                onClick={() =>
                  router.push(`/dashboard/websites/${params.id}/assets`)
                }
              >
          ...
          <Card>
            ...
            <CardFooter>
              <Button
                variant="outline"
                onClick={() =>
                  router.push(`/dashboard/websites/${params.id}/settings`)
                }
              >
        ...
        <TabsContent value="analytics" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View statistics and insights about your website.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="domains" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Connect custom domains to your website.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
              ...
              <Button
                onClick={() =>
                  router.push(`/dashboard/domains?websiteId=${params.id}`)
                }
        ...
        <TabsContent value="integrations" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Connect third-party services to your website.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
              ...
              <Button
                onClick={() =>
                  router.push(`/dashboard/integrations?websiteId=${params.id}`)
                }
                disabled={website.plan === "starter"}
              >
                Manage Integrations
