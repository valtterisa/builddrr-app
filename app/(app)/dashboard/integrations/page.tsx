...
export default function IntegrationsPage() {
  ...
  const integrationTypes = [
    {
      ...
      name: "Email Service",
      description:
        "Connect an email service to send form submissions and notifications.",
      icon: Mail,
      providers: [
    ...
    },
    {
      ...
      description:
        "Connect payment processors to accept payments on your website.",
      icon: CreditCard,
      providers: [
  ...
  const handleConfirmConnect = () => {
    ...
    const selectedType = integrationTypes.find(
      (type) => type.id === selectedIntegrationType
    );
    ...
    <div className="container py-10 px-4 md:px-6">
            ...
            <Card className="border-amber-200 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-800">
              ...
              <CardContent>
                <p className="text-amber-700 dark:text-amber-300">
                  ...
                  Upgrade to connect email services, form handlers, and more.
                </p>
              </CardContent>
              <CardFooter>
                <Button
            ...
            <div className="grid gap-4">
              {integrations.map((integration) => {
                const integrationType = integrationTypes.find(
                  (type) => type.id === integration.type
                );
                const provider = integrationType?.providers.find(
        ...
        <TabsContent value="available" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Explore integrations you can connect to your website.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {plan === "starter" ? (
                ...
                <div className="space-y-4">
                      ...
                      type.providers
                        ...
                        .map((provider) => (
                          ...
                          >
                            ...
                            <Button
                              size="sm"
                              onClick={() => handleConnectIntegration(type.id)}
                            >
                              Connect
                            </Button>
                          </div>
                  ...
                  <div className="bg-muted p-4 rounded-md">
                    <p className="text-sm text-muted-foreground">
                      ...
                      Need a specific integration? Contact our support team for
                      assistance.
                    </p>
                  </div>
                </div>
      ...
      <Dialog open={showUpgradeDialog} onOpenChange={setShowUpgradeDialog}>
        <DialogContent>
          ...
          <div className="py-4">
            <p className="mb-4">
              Upgrade to Pro to connect email services, form handlers, payment
              processors, and more.
            </p>
